...
class HybridAuthFactory implements FactoryInterface
{
    public function createService(ServiceLocatorInterface $services)
    {
        ...
        $configsData = $services->get('config');
        $socialConfig = $configsData['social_authentication'];
            ...
            array(
                ...
                'providers' => array(
                    'Facebook' => array(
                        ...
                        'keys' => array(
                            'id' => $socialConfig['facebookClientId'],
                            'secret' => $socialConfig['facebookSecret'],
                        ),
                    ...
                    'Google' => array(
                        ...
                        'keys' => array(
                            'id' => $socialConfig['googleClientId'],
                            'secret' => $socialConfig['googleSecret'],
                        ),
                    ...
                    'Twitter' => array(
                        ...
                        'keys' => array(
                            'key' => $socialConfig['twitterConsumerKey'],
                            'secret' => $socialConfig['twitterConsumerSecret'],
                        ),
                    ),
                    'Yahoo' => array(
